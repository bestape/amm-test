...
/// @notice This library is a demonstration of how Uniswap's TickMath can be expressed
/// using Base Scale Calculus, where a^2 + b^2 = c^2 and d = (c - b) / a.
/// The price is related to the tick by the formula price = (1/d)^tick.
/// For compatibility with Uniswap, we set d = 1 / 1.0001.
...
library BaseScaleTickMath {
    ...
    /// where price = (1/d)^tick and d = 1/1.0001.
    /// This is equivalent to log_sqrt(1.0001)(sqrt(price)).
