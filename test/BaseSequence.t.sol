...
contract BaseSequenceTest is Test {
    /// @dev Generates the n-th term of a Base Sequence that approximates 1 + sqrt(2).
    ...
    function test_base_sequence_approximation() public {
